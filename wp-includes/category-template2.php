			...
			switch ( strtolower( $parents ) ) {
				case 'multiple':
					if ( $category->parent )
						...
						if ($category->slug){
							$thelist .= '<a class="cat_'.$category->slug.'" href="' . esc_url( get_category_link( $category->term_id ) ) . '" ' . $rel . '>' . $category->name.'</a></li>';
						} else{
							$thelist .= '<a href="' . esc_url( get_category_link( $category->term_id ) ) . '" ' . $rel . '>' . $category->name.'</a></li>';
						}
					break;
				case 'single':
					$thelist .= '<a class="cat_'.$category->slug.'" href="' . esc_url( get_category_link( $category->term_id ) ) . '"  ' . $rel . '>';
					if ( $category->parent )
		...
		foreach ( $categories as $category ) {
			...
			switch ( strtolower( $parents ) ) {
				case 'multiple':
					if ( $category->parent )
						$thelist .= get_category_parents( $category->parent, true, $separator );
					$thelist .= '<a class="cat_'.$category->slug.'" href="' . esc_url( get_category_link( $category->term_id ) ) . '" ' . $rel . '>' . $category->name.'</a>';
					break;
				case 'single':
					$thelist .= '<a class="cat_'.$category->slug.'" href="' . esc_url( get_category_link( $category->term_id ) ) . '" ' . $rel . '>';
					if ( $category->parent )
