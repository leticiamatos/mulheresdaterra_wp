...
<?php if ( is_home() ) : ?>
		...
		<section class="block_wpr home_cntt">
			...
			<div style="width: auto; height: 100%;" data-vide-bg="<?php echo get_site_url(); ?>/wp-content/uploads/2016/02/mulheresdaterravideo.webm" data-vide-options="loop: true, muted: true, position: 0% 0%"></div>
